...
fn build_css(build: &mut Build) -> Result<()> {
    ...
    let highlight_css = build.inputs_with_suffix(
        inputs![
    ...
    build.add(
        "qt/aqt:data/web/css",
        CopyFiles {
            inputs: highlight_css.into(),
            output_folder: "qt/_aqt/data/web/css/highlight/",
        },
    )?;
    ...
    build.add(
        ...
        CopyFiles {
            inputs: inputs![
                ...
                "qt/aqt/data/web/js/vendor/codejar.js",
                "qt/aqt/data/web/js/vendor/linenumbers.js",
                "qt/aqt/data/web/js/vendor/highlight.js",
                "qt/aqt/data/web/js/vendor/jqmeter.js",
                "qt/aqt/data/web/js/vendor/prism.js",
            ],
