...
fn build_and_check_reviewer(build: &mut Build) -> Result<()> {
    ...
    build.add(
        "ts:reviewer:font.css",
        CompileSass {
            input: inputs!["ts/reviewer/font.scss"],
            output: "ts/reviewer/font.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        "ts:reviewer:highlight:agate.css",
        CompileSass {
            input: inputs!["ts/reviewer/highlight/agate.css"],
            output: "ts/reviewer/highlight/agate.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        "ts:reviewer:highlight:androidstudio.css",
        CompileSass {
            input: inputs!["ts/reviewer/highlight/androidstudio.css"],
            output: "ts/reviewer/highlight/androidstudio.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        "ts:reviewer:highlight:atom-one-dark.css",
        CompileSass {
            input: inputs!["ts/reviewer/highlight/atom-one-dark.css"],
            output: "ts/reviewer/highlight/atom-one-dark.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        ...
        CompileSass {
            input: inputs!["ts/reviewer/highlight/atom-one-light.css"],
            output: "ts/reviewer/highlight/atom-one-light.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        ...
        CompileSass {
            input: inputs!["ts/reviewer/highlight/code-brewer.css"],
            output: "ts/reviewer/highlight/code-brewer.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
    build.add(
        ...
        CompileSass {
            input: inputs!["ts/reviewer/highlight/dracula.css"],
            output: "ts/reviewer/highlight/dracula.css",
            deps: ":sass".into(),
            load_paths: vec!["."],
        },
    )?;
