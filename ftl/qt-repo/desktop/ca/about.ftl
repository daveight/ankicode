...
about-copied-to-clipboard = S'ha copiat al porta-retalls
about-copy-debug-info = Copia la informació de depuració
about-if-you-have-contributed-and-are = Si heu contribuït al projecte però no sou a la llista, poseu-vos en contacte amb nosaltres.
