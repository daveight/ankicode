...
addons-browse-addons = Eklentileri Göz At
...
addons-please-restart-anki-to-complete-the = <b>Yüklemeyi tamamlamak için lütfen Anki'yi yeniden başlatınız.</b>
...
addons-the-following-addons-are-incompatible-with = Aşağıdaki eklentiler, { $name } ile uyumlu değildir devre dışı bırakılmıştır: { $found }
