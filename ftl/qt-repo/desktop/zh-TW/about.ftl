...
about-if-you-have-contributed-and-are = 如果你有貢獻但是未列於清單中，請跟我們聯絡。
about-version = 版本 { $val }
about-visit-website = <a href='{ $val }'>造訪網站</a>
about-written-by-damien-elmes-with-patches = 作者：Damien Elmes，以及修補程式、翻譯、測試和設計人員：<p>{ $cont }
