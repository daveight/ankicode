qt-misc-addon-will-be-installed-when-a = Lisäosa asennetaan, kun profiili avataan.
...
qt-misc-unable-to-record =
    Tallennus ei onnistu. Varmista, että mikrofoni on kytketty ja että Ankilla on lupa käyttää mikrofonia.
    Jos muut ohjelmat käyttävät mikrofonia, niiden sulkeminen voi auttaa.
    
    Alkuperäinen virhe: { $error }
