...
browsing-learning = (á bhfoghlaim)
browsing-line-size = <b>Méid Líne</b>:
...
browsing-sorting-on-this-column-is-not = Ní féidir sórtáil de réir an cholúin seo. Roghnaigh ceann eile.
browsing-start-position = Áit thosaigh:
browsing-step = Céim:
...
browsing-sidebar-saved-searches = Cuardaigh Shábháilte
browsing-sidebar-save-current-search = Sábháil Cuardach Reatha
