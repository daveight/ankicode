...
browsing-browser-appearance = مظهر المتصفّح
...
browsing-window-title-notes = تصفح ({ $selected } من أصل { $total } ملحوظة محددة)
...
browsing-sidebar-notetypes = أنواع ملحوظات
browsing-sidebar-saved-searches = عبارات البحث المحفوظة
browsing-sidebar-save-current-search = حفظ البحث الحالي
