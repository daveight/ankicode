...
browsing-sidebar-notetypes = 笔记模板
...
browsing-tooltip-question = 卡片正面，可在内容模板编辑器中自定义
browsing-tooltip-answer = 卡片背面，可在内容模板编辑器中自定义
browsing-studied-today = 今天学习的
browsing-added-today = 今天添加的
browsing-again-today = 今天重来的
