...
browsing-browser-appearance = Zobrazení v prohlížeči
...
browsing-find = <b>Najít</b>:
browsing-find-and-replace = Najít a nahradit
browsing-find-duplicates = Najít duplikáty
browsing-first-card = První karta
...
browsing-last-card = Poslední karta
browsing-learning = (učí se)
...
browsing-queue-top = Začátek fronty: { $val }
browsing-randomize-order = Náhodné řazení
browsing-remove-tags = Odstranit štítky...
browsing-replace-with = <b>Nahradit</b>:
browsing-reposition = Změnit pořadí...
browsing-reposition-new-cards = Změnit pořadí nových karet
browsing-reschedule = Přeplánovat
...
browsing-edited-today = Upraveno
browsing-sidebar-first-review = První opakování
browsing-sidebar-rescheduled = Přeplánováno
