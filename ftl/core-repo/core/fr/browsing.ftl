...
browsing-find-duplicates = Trouver les doublons
browsing-first-card = Première carte
...
browsing-last-card = Dernière carte
browsing-learning = (apprentissage)
browsing-line-size = <b>Longueur de ligne</b> :
...
browsing-treat-input-as-regular-expression = Traiter la saisie comme une expression régulière
browsing-update-saved-search = Mettre à jour avec la recherche actuelle
browsing-whole-collection = Toute la collection
browsing-window-title-notes = Parcourir ({ $selected } sur { $total } notes sélectionnées)
...
browsing-tooltip-question = La face avant d'une carte, personnalisable dans l'éditeur de modèle.
browsing-tooltip-answer = La face arrière d'une carte, personnalisable dans l'éditeur de modèle.
