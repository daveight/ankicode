...
preferences-paste-clipboard-images-as-png = 自動將圖像轉換為 PNG 格式再貼上
preferences-paste-without-shift-key-strips-formatting = 自動清除文字格式（貼上時無需按住 shift 鍵）
preferences-periodically-sync-media = 定期同步媒體
preferences-please-restart-anki-to-complete-language = 請重啟 Anki 完成語言更動。
...
preferences-when-adding-default-to-current-deck = 預設新增筆記到當前牌組
