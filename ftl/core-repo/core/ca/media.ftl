...
media-recordingtime = S'està enregistrant…<br>Temps: { $secs }
media-sound-and-video-on-cards-will = El so i el vídeo de les targetes no funcionarà fins que instal·leu mpv o mplayer.
