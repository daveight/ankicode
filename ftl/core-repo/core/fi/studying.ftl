...
studying-buried-siblings = Piilotetut sisarkortit
...
studying-show-answer = Näytä vastaus
studying-space = Välilyönti
studying-study-now = Opiskele nyt
studying-suspend = Hyllytä
studying-suspend-note = Hyllytä muistiinpano
studying-this-is-a-special-deck-for = Tämä on erikoispakka, jota käytetään normaalin ajastuksen ulkopuoliseen opiskeluun.
