...
statistics-today-no-mature-cards = Žiadne zrelé karty ste dnes neštudovali.
...
statistics-axis-label-answer-count = Odpovede
statistics-axis-label-card-count = Karty
statistics-axis-label-review-time = Čas na opakovanie
