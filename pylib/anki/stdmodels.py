...
def _legacy_add_coding_model(
    col: anki.collection.Collection,
) -> anki.models.NotetypeDict:
    note_type = _get_stock_notetype(col, StockNotetypeKind.CODING_TASK)
    col.models.add(note_type)
    return note_type
...
_deprecated_names.register_deprecated_attributes(
    ...
    addCodingTaskModel=(_legacy_add_coding_model, get_stock_notetypes),
)
